...
describe('lesson.validator', () => {
  ...
  it('accepts course, module, and lesson route params', () => {
    ...
    expect(moduleRouteParamsSchema.parse({ moduleId: '22222222-2222-2222-2222-222222222222' })).toEqual({
    ...
    expect(lessonRouteParamsSchema.parse({ lessonId: '44444444-4444-4444-4444-444444444444' })).toEqual({
