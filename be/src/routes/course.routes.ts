...
router.get(
  ...
  asyncHandler(courseController.getPublicById),
);
...
router.get(
  ...
  authenticate,
  validate(courseIdParamsSchema, 'params'),
  asyncHandler(courseController.listPublishedModules),
);
router.get(
  '/:id/resources',
  authenticate,
  validate(courseIdParamsSchema, 'params'),
  asyncHandler(courseController.listResources),
);
...
router.post(
  ...
  authorize(PERMISSIONS.COURSE_UPDATE),
  validate(courseIdParamsSchema, 'params'),
  asyncHandler(courseController.publish),
);
router.post(
  '/:id/archive',
  authenticate,
  authorize(PERMISSIONS.COURSE_UPDATE),
  validate(courseIdParamsSchema, 'params'),
  asyncHandler(courseController.archive),
);
router.patch(
  '/:id/thumbnail',
  authenticate,
  ...
  validate(courseIdParamsSchema, 'params'),
  courseThumbnailUpload.single('thumbnail'),
  asyncHandler(courseController.updateThumbnail),
);
router.delete(
  '/:id',
  authenticate,
...
router.post(
  '/:id/restore',
  authenticate,
  authorize(PERMISSIONS.COURSE_RESTORE),
  validate(courseIdParamsSchema, 'params'),
