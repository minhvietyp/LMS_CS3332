...
router.get(
  ...
  asyncHandler(lessonController.listCourseModules),
);
router.post(
  '/courses/:courseId/modules',
  validate(courseIdParamsSchema, 'params'),
  validate(createModuleSchema),
  asyncHandler(lessonController.createModule),
);
router.patch(
  '/courses/:courseId/modules/reorder',
  validate(courseIdParamsSchema, 'params'),
  validate(reorderModulesSchema),
  asyncHandler(lessonController.reorderModules),
);
router.patch(
  '/modules/:id',
  validate(moduleIdParamsSchema, 'params'),
  validate(updateModuleSchema),
  asyncHandler(lessonController.updateModule),
);
router.delete(
  '/modules/:id',
  validate(moduleIdParamsSchema, 'params'),
  asyncHandler(lessonController.deleteModule),
);

// ─── Lessons ──────────────────────────────────────────────────────────────
router.post(
  '/modules/:moduleId/lessons',
  validate(moduleRouteParamsSchema, 'params'),
...
router.get(
  ...
  asyncHandler(lessonController.listMaterials),
);
router.post(
  '/lessons/:lessonId/materials',
  validate(lessonRouteParamsSchema, 'params'),
  validate(createMaterialSchema),
  asyncHandler(lessonController.addMaterial),
);
router.post(
  '/lessons/:lessonId/materials/upload',
  validate(lessonRouteParamsSchema, 'params'),
  lessonMaterialUpload.single('file'),
  validate(createUploadedMaterialSchema),
  asyncHandler(lessonController.uploadMaterial),
);
router.delete(
  '/materials/:id',
  validate(materialIdParamsSchema, 'params'),
  asyncHandler(lessonController.deleteMaterial),
);
