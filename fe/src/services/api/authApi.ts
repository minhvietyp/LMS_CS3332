...
export interface PublicInstructorProfile extends AuthUser {
  courseCount?: number;
  studentCount?: number;
...
export async function listPublicInstructorsRequest(): Promise<PublicInstructorProfile[]> {
  try {
...
export async function getPublicInstructorByIdRequest(userId: string): Promise<PublicInstructorProfile> {
  try {
