...
import { ClientAssignmentSubmissionPage } from './ClientAssignmentSubmissionPage';
import { ClientCourseAssignmentsPage } from './ClientCourseAssignmentsPage';
...
describe('Client assignment pages', () => {
  ...
  it('renders course assignments with submission status', async () => {
    ...
    expect(await screen.findByText('Build a Landing Page')).toBeInTheDocument();
