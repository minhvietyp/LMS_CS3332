...
import { QuizManagement } from './index';
...
describe('QuizManagement', () => {
  ...
  it('creates a new assignment from the assignments tab', async () => {
    ...
    fireEvent.change(within(dialog).getByPlaceholderText('Week 1 implementation task'), {
      target: { value: 'Week 2 assignment' },
    });
    fireEvent.change(within(dialog).getByPlaceholderText('Describe what learners need to submit.'), {
